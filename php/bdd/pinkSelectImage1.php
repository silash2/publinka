...
$imagea = explode(".",$pin['image']);
$imageAfterPointi = strtolower(end($imagea));
$exti = ['jpg','png','gif','jpeg'];

if (in_array($imageAfterPointi,$exti)) {
    $nombres = $nombres +1;
?>
...
if ($nombres == 0) {
    echo "<h4 id='affichage'> Il n'y a pas de fichier...</h4>";
}
?>
<div class="col-1" style="margin-left:1cm">
<button id="prevs" style="" ></button>
<br>
<b id="resultatse"></b> 
<b id="bare"></b>
<b id="comptese"></b>
